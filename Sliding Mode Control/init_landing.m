...
%   plot3(ref(:,1),ref(:,2),ref(:,3),'--gs','LineWidth',1,'MarkerSize',1,'MarkerEdgeColor','r');
    ...
    %h = plot3(0, 0, z(1), 'o', 'MarkerSize' ,10, 'MarkerFaceColor', 'b');
    plot3(0, 0, 0, 'o', 'MarkerSize' ,10, 'MarkerFaceColor', 'b');
    %xlim([-1.5, 1.5]);
    %ylim([-1.5, 1.5]);
    %zlim([-1.5, 1.5]);
